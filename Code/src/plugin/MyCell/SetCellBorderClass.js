...
/**
 * @fileoverview 设置单元格边框模块，提供边框样式设置对话框
 * @module SetCellBorderClass
 */
 ...
 */
function SetCellBorderClass(config) {
    ...
    function setupContent() {
        ...
        var s = "<style>"
            ...
            + "<tr>"
            + "    <th>线条粗细</th><td colspan='3'>"
            + "<select id='select_lineStyle'>"
            + "<option value='2'>细线</option>"
            + "<option value='3'>中线</option>"
            + "<option value='4'>粗线</option>"
            + "<option value='5'>虚线</option>"
            + "<option value='6'>点线</option>"
            + "<option value='7'>点虚线</option>"
            + "<option value='8'>点点虚线</option>"
            + "<option value='9'>粗虚线</option>"
            + "<option value='10'>粗点线</option>"
            + "<option value='11'>粗点虚线</option>"
            + "<option value='12'>粗点点虚线</option>"
            + "</select></td>"
            + "</tr>"
            + "<tr>"
            ...
            + "<input type='button' class='myButton1' value='画线' id='" + confirmButtonId + "'/>"
            + "&nbsp;&nbsp;"
        ...
        document.getElementById(confirmButtonId).onclick = function () {
            parentObj.setCellBorder_setValue();
        };
    }
