...
function LeftLabel(config) {
    ...
    var id = "leftLabel_" + parentId;
    var labelDivs = [];
    var splitorDivs = [];

    parentEl.style.left = leftLabelWidth + leftLabelPadding + "px";
    ...
    var totalWidth = leftLabelWidth;
    var totalHeight = parentElHeight - topLabelHeight;
    parentEl.style.height = totalHeight + "px";
    totalHeight = totalHeight + 6;
    contentEl.style.width = totalWidth + "px";
    contentEl.style.height = totalHeight + "px";

    contentContentEl.style.position = "relative";
    contentContentEl.style.left = "0px";
    contentContentEl.style.top = "0px";
    contentContentEl.style.width = totalWidth + "px";
    contentContentEl.style.height = totalHeight + "px";

    contentEl.style.userSelect = "none";
    contentEl.style.position = "absolute";
    contentEl.style.left = "0px";
    contentEl.style.top = topLabelHeight + topLabelPadding + toolbarHeight + formulaBarHeight + "px";
    ...
    document.addEventListener("mouseup", function (e) {
        ...
        if (leftLabelIsMouseDown) {
            leftLabelIsMouseDown = false;
            leftLabelSelectStartRow = -1;
            leftLabelSelectEndRow = -1;
        }
    });
    ...
    function setCanvasHeight(height) {
        contentContentEl.style.height = height + "px";
    }
     ...
     */
    function drawOneLabel(row, str, x, y, width, height) {
        ...
        new OperLeftLabel(labelDiv, row, labelDivs, splitorDivs, parentObj);
        drawSplitor(x, y, width, height, row, labelDiv);
    }
     ...
     */
    function drawSplitor(x, y, width, height, row, forElement) {
        var splitorDiv = document.createElement("div");
        splitorDiv.style.position = "absolute";
        var top = y + height - 1;
        splitorDiv.style.top = top + "px";
        splitorDiv.style.left = "0px";
        splitorDiv.style.height = "4px";
        splitorDiv.style.width = width + "px";
        splitorDiv.style.textAlign = "center";
        splitorDiv.style.zIndex = 2;
        splitorDiv.style.cursor = "row-resize";
    ...
    function drawBackground() {
        ...
        contentEl.style.borderRight = "1px solid #DBDBDB";
    }
    ...
    function removeAllExpandImage() {
        var expandElements = contentContentEl.querySelectorAll(".div_expand_row");
    ...
    function drawExpandImageOne(labelDivInfo) {
        ...
        expandDiv.setAttribute("class", "div_expand_row");
        expandDiv.style.backgroundImage = "url(data:image/png;base64,)";
    ...
    function scroll(deltaY) {
        contentContentEl.style.top = -deltaY + "px";
    }
     ...
     */
    function unHilightLeftLabelX(startRow, endRow) {
        unHilightLeftLabel(labelDivs, splitorDivs, startRow, endRow);
    }
     ...
     * @param {number} row - 行号
     */
    function showHilightLeftLabelOneX(row) {
        showHilightLeftLabelOne(labelDivs, splitorDivs, row);
    }

    /**
     * 显示展开行图像
     */
    function showExpandRowImageX() {
    ...
    return {
        ...
        unHilightLeftLabelX: unHilightLeftLabelX,
        showHilightLeftLabelOneX: showHilightLeftLabelOneX,
        showExpandRowImageX: showExpandRowImageX,
    };
}
