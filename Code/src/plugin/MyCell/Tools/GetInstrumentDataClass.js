...
/**
 * @fileoverview 获取仪器数据类 - 提供仪器信息提取功能
 * @description 该模块用于从表格中提取仪器设备信息，
 * 包括仪器名称、型号、编号和使用情况。
 ...
 */
function GetInstrumentDataClass(config) {
   ...
   * 执行仪器数据提取
   * @function doJob
   * @description 遍历表格查找仪器名称标题，提取所有仪器信息
   * @returns {Array.<Object>} 仪器数据数组，每项包含name、type、num、usage属性
   */
  function doJob() {
    var L = [];
   ...
   * 处理仪器区域（包含使用情况列）
   * @function doJobA
   * @description 从仪器名称标题位置开始，提取名称、型号、编号、使用情况
   * @param {number} col - 列索引
   * @param {number} row - 行索引
   * @returns {Array.<Object>|undefined} 仪器数据数组或undefined
   */
  function doJobA(col, row) {
    ...
    var instrumentNameAr = getInstrumentNameAr(L);
    ...
    var instrumentUsageAr = getOtherAr(L[3], count);
    var L1 = [];
  ...
  /**
   * 获取仪器名称数组
   * @function getInstrumentNameAr
   * @description 从仪器名称标题下方提取所有仪器名称
   * @param {Array.<Object>} L - 单元格位置数组
   * @returns {Array.<string>} 仪器名称数组
   */
  function getInstrumentNameAr(L) {
   ...
   * 处理仪器区域（不含使用情况列）
   * @function doJobB
   * @description 从仪器名称标题位置开始，提取名称、型号、编号
   * @param {number} col - 列索引
   * @param {number} row - 行索引
   * @returns {Array.<Object>|undefined} 仪器数据数组或undefined
   */
