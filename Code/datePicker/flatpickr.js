...
!(function (e, n) {
  ...
  function k(p, v) {
    ...
    function _(e) {
      ...
      var a = w._input.innerText;
      O(), ye(), w._input.innerText !== a && w._debouncedChange();
    }
    ...
    function ae(e) {
      var n = e.target === w._input,
        t = w._input.innerText.trimEnd() !== Me();
      !n ||
        !t ||
    ...
    (w.parseDate = C({ config: w.config, l10n: w.l10n })),
      ...
      (w.clear = function (e, n) {
        void 0 === e && (e = !0);
        void 0 === n && (n = !0);
        (w.input.innerText = ""), void 0 !== w.altInput && (w.altInput.value = "");
      ...
      if (void 0 !== w.config) {
        ...
        if (void 0 !== t && t.length > 0)
          for (var a = 0; t[a] && a < t.length; a++)
            t[a](w.selectedDates, w.input.innerText, w, n);
        "onChange" === e &&
        ...
        void 0 !== w.mobileInput &&
          ...
          (w.mobileInput.value =
            void 0 !== w.latestSelectedDateObj
              ...
              : ""),
        (w.input.innerText = Me(w.config.dateFormat)),
        ...
        (w.element = w.input = p),
          ...
          (function () {
            ...
            var e =
              ...
              !w.input.placeholder ||
              w.input.innerText !== w.input.placeholder
                ? w.input.innerText
                : null);
